...
df <- read_csv("../generated_csvs/STOPPD_masterDF_2018-09-06.csv",
na = "empty") #spreadsheet created by 03_STOPPD_masterDF.rmd

CT <- read_csv('../data/fs-enigma-long_201809/CorticalMeasuresENIGMA_ThickAvg.csv') #bring in CT data, from pipelines
...
# write.csv
write_csv(ana_df, '../generated_csvs/STOPPD_participantsCT_20180914.csv')
```
...
#write.csv
  write.csv(CT_wide_controls, '../generated_csvs/STOPPD_errorControls_2018-09-14.csv', row.names = FALSE)
```
