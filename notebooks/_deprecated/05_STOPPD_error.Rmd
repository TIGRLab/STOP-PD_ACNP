...
df <- read.csv('../generated_csvs/STOPPD_masterDF_2018-11-05.csv', na.strings = "", stringsAsFactors = FALSE) #spreadsheet created by 03_STOPPD_masterDF.rmd

CT <- read.csv('../data/fs-enigma-long_201809/CorticalMeasuresENIGMA_ThickAvg.csv', stringsAsFactors = FALSE) #bring in CT data, from pipelines
...
#write.csv
  write.csv(df, '../generated_csvs/STOPPD_errorCases_2018-11-05.csv', row.names = FALSE)
...
#write.csv
  write.csv(controls, '../generated_csvs/STOPPD_errorControls_2018-11-05.csv', row.names = FALSE)
